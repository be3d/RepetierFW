...
FSTRINGVAR(tVersion)
FSTRINGVAR(tEcho2)
FSTRINGVAR(tExternalReset2)
FSTRINGVAR(tDefaultZOffset)
FSTRINGVAR(tActualZOffset)
FSTRINGVAR(tTacho_ext)
FSTRINGVAR(tTacho_num)
FSTRINGVAR(tEndPrint)
//end of myline
#if JSON_OUTPUT
FSTRINGVAR(tJSONDir)
