...
#define VERSION_STRING  "6.6.6" //"1.4.31"
...
*/
#define BLUETOOTH_SERIAL   -1//1                      // Port number (1..3) - For RUMBA use 3
...
For xy gantry use 2*belt moved!
Overridden if EEPROM activated.*/
#define YAXIS_STEPS_PER_MM 106.6666
/** \brief Number of steps for a 1mm move in z direction  Overridden if EEPROM activated.*/
#define ZAXIS_STEPS_PER_MM 1244.4444
#endif
...
#define EXT0_STEPS_PER_MM 105 //385
...
#define ZHOME_X_POS 0//(X_MAX_LENGTH/2) //IGNORE_COORDINATE
#define ZHOME_Y_POS 0//(Y_MAX_LENGTH/2) //IGNORE_COORDINATE
...
#define Z_PROBE_Z_OFFSET 0//21 //10 //21.55 // offset to coating form real bed level
...
#define Z_PROBE_X_OFFSET 0//30//29.8
#define Z_PROBE_Y_OFFSET 0//30//-62.5
 // odjezd stolu pri spustenem servu - raise between probing
#define Z_PROBE_BED_DISTANCE 5////0-21.55 // Higher than max bed level distance error in mm
...
#define Z_PROBE_Y2 100//50
#define Z_PROBE_X3 100//550
#define Z_PROBE_Y3 50//350
