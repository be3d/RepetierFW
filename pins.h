...
#define ORIG_X_DIR_PIN          23
#define ORIG_X_MIN_PIN          26
#define ORIG_X_MAX_PIN           -2

#define ORIG_Y_STEP_PIN         20
#define ORIG_Y_DIR_PIN          19
#define ORIG_Y_MIN_PIN          15
#define ORIG_Y_MAX_PIN          -1

#define ORIG_Z_STEP_PIN         18
#define ORIG_Z_DIR_PIN          17
#define ORIG_Z_MIN_PIN          11
#define ORIG_Z_MAX_PIN          10 //-1

#define ORIG_E0_STEP_PIN         3
#define ORIG_E0_DIR_PIN          2

#define ORIG_E1_STEP_PIN         0
#define ORIG_E1_DIR_PIN          29


#define LED_PIN            -1

#define ORIG_FAN_PIN            30 //-1
...
// (bed)
#define HEATER_1_PIN       12//12 
#define ORIG_X_ENABLE_PIN       21
#define ORIG_Y_ENABLE_PIN       21
#define ORIG_Z_ENABLE_PIN       21
#define ORIG_E0_ENABLE_PIN       21
#define ORIG_E1_ENABLE_PIN       1
#else

#define HEATER_1_PIN       12//14  // (bed)
#define ORIG_X_ENABLE_PIN       21//-1
#define ORIG_Y_ENABLE_PIN       21//-1
#define ORIG_Z_ENABLE_PIN       21//-1
#define ORIG_E0_ENABLE_PIN      21//-1
#define ORIG_E1_ENABLE_PIN      1
